"""
Workflow Orchestrator - Connects all agents in the visualization pipeline.

Pipeline:
User -> Communication Agent -> Plot Generator -> Router -> Optimizer -> Verifier -> User
"""
...
class WorkflowOrchestrator:
    """Orchestrates the complete visualization workflow"""
    ...
    def chat(self, user_message: str) -> Dict[str, Any]:
        ...
        try:
            ...
            comm_response = self.communication_agent.chat(
...
The code has been verified and is ready to use!"""
    ...
    def new_session(self):
        """Start a new session, clearing history but keeping data"""
